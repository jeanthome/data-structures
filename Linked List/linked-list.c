...
/**
* Imprime o tamanho da lista e seus respectivos elementos, do começo para o final.
...
/**
* Imprime o tamanho da lista e seus respectivos elementos, do final para o começo.
* @param l Ponteiro para a lista a ser impressa.
*/
void reverse_print(LinkedList *l) {
  Node * node = l->tail;
